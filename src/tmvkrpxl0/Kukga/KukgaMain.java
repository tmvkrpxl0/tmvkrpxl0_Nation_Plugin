...
public class KukgaMain extends JavaPlugin {
	...
	public void onEnable() {
		...
		Objective obj = Bukkit.getScoreboardManager().getMainScoreboard().registerNewObjective("showHealth-Kukga", "health");
		...
		//밑에 3개말고 더 넣지 마셈
		KukgaListener.changeHardness(Material.IRON_DOOR, Config.getTerritory().get("ironDoorBreakTime"));
		KukgaListener.changeHardness(Material.IRON_DOOR_BLOCK, Config.getTerritory().get("ironDoorBreakTime"));
		KukgaListener.changeHardness(Material.BEACON, Config.getTerritory().get("beaconBreakTime"));
		}
	}
